using Demo.SFS_SmokeTest.TestScripts.SessionTimeout;
...
namespace Demo.SFS_SmokeTest.TestScripts
{
    ...
    [TestClass]
    public class P1_TC_ProductInfo
    {


        [DataTestMethod]
        [CsvDataSource("SFS_SmokeTest/TestData/Login.csv")]
        public void P1_TC_ProductInfoPage(string cid, string userName, string passWord)
        {
